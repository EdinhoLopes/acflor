...
class PresencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presence" do
    assert_difference("Presence.count") do
      post presences_url, params: { presence: { date_of_day: @presence.date_of_day, presence: @presence.presence, student_course_id: @presence.student_course_id, teacher_course_id: @presence.teacher_course_id } }
    end
  ...
  test "should update presence" do
    patch presence_url(@presence), params: { presence: { date_of_day: @presence.date_of_day, presence: @presence.presence, student_course_id: @presence.student_course_id, teacher_course_id: @presence.teacher_course_id } }
