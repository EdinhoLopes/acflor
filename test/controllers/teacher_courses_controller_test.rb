...
class TeacherCoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher_course" do
    assert_difference("TeacherCourse.count") do
      post teacher_courses_url, params: { teacher_course: { course_id: @teacher_course.course_id, teacher_id: @teacher_course.teacher_id } }
    end
  ...
  test "should update teacher_course" do
    patch teacher_course_url(@teacher_course), params: { teacher_course: { course_id: @teacher_course.course_id, teacher_id: @teacher_course.teacher_id } }
