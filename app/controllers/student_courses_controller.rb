  ...
  def create
    ...
    respond_to do |format|
      if @student_course.save
        format.html { redirect_to student_course_url(@student_course), notice: "Student course was successfully created." }
  ...
  def update
    respond_to do |format|
      if @student_course.update(student_course_params)
        format.html { redirect_to student_course_url(@student_course), notice: "Student course was successfully updated." }
