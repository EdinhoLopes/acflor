class TeachersController < ApplicationController
  ...
  private
    ...
    def teacher_params
      params.require(:teacher).permit(:name, :date_of_birth, :address, :phone, :email, :rg, :cpf, :pis, :cnpj, :profession, :teaching_experience, :professional_experience, :area_of_specialization)
    end
end
